...
## 概要<br>
漫画の画像を投稿。画像を投稿することで気になっていた漫画を視て理解させる事が目的。
...
漫画を画像付きで投稿することでどんな漫画だったかを視て理解し、気になる漫画を保存できるのではと考えアプリを作成した。

##### 詳細な説明<br>
・漫画を投稿すると投稿してきた漫画がマイページにて表示。<br>
・投稿した漫画はTopページから他ユーザーも閲覧可能。<br>
...
## 今後の実装
・javascriptを用いたビューの整形<br>
・一つの漫画にコメントできるコメント機能<br>
